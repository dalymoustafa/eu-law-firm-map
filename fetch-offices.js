...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("eu law firm")
  );

  if (!record) { console.error("Could not find EU Law Firm!"); process.exit(1); }
...
<head>
  ...
  <title>EU Law Firm — Office Locations</title>
